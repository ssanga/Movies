...
namespace Movies.API.Controllers
{
    ...
    public class MoviesController : ControllerBase
    {
        ...
        public async Task<ActionResult<Movies>> GetMovieById([FromRoute] int id)
        {
        ...
        [HttpGet]
        [Route("{name}", Name = "GetMovieByName")]
        public async Task<ActionResult<IEnumerable<Movies>>> GetMoviesByName([FromRoute] string name)
        {
            var data = await _moviesService.GetMoviesAsync(name);
